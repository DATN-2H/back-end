...
public class PageResponse<T> {
    ...
    public static <S, T> PageResponse<T> convertPageResponse(
        PageResponse<S> page,
        ...
        pageResponse.setData(
            RequestHelper.createDtoList(page.getData(), mapFunction)
        );
        return pageResponse;
    }

    public static <S, T> PageResponse<T> buildPageDtoResponse(
        Page<S> page,
        Function<S, T> mapFunction
    ) {
        PageResponse<T> pageResponse = new PageResponse<>();
        ...
        pageResponse.setPage(page.getPageable().getPageNumber());
        pageResponse.setData(
            RequestHelper.createDtoList(page.getContent(), mapFunction)
        );
        return pageResponse;
    }
