...
public class Response<T> {
    ...
    public static Response<ApiMessageBase> ofApiMessage(
        ApiMessageBase apiMessage
    ) {
        return new Response<>(
            true,
            ApiMessageBase.SUCCESS,
            new ApiMessageBase(apiMessage.code, apiMessage.message)
        );
    }
    ...
    public static void servletResponse(
        ...
        servletResponse(
            response,
            apiMessage,
            mapHttpStatus(apiMessage.getCode()),
            false
        );
    }
    ...
    public static void servletResponse(
        ...
        String responseString = RequestHelper.convertToJson(
            Response.error(apiMessage)
        );
