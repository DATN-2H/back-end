...
public class RestExceptionHandler {
    ...
    public void handleHttpMediaTypeException(
        ...
        Response.servletResponse(
            response,
            ApiMessageBase.UNSUPPORTED_MEDIA_TYPE
        );
    }
    ...
    public void handleInvalidFormatException(
        ...
        if (ex.getPath() != null && !ex.getPath().isEmpty()) {
            ...
            Response.servletResponse(
                response,
                ApiMessageBase.NOT_READABLE_PARAM
            );
        }
    }
    ...
    public void handleConstraintViolationException(
        ...
        Response.servletResponse(
            response,
            ApiMessageBase.DATA_INTEGRITY_VIOLATION.getCode(),
            ApiMessageBase.DATA_INTEGRITY_VIOLATION.getMessage() +
            " - " +
            exception.getMessage()
        );
    }
    ...
    public void handleUnknownException(
        ...
        Response.servletResponse(
            response,
            ApiMessageBase.INTERNAL_SERVER_ERROR
        );
    }
}
