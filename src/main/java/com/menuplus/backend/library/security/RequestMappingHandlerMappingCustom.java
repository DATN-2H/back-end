...
public class RequestMappingHandlerMappingCustom extends RequestMappingHandlerMapping {
    ...
    private static final ThreadLocal<RequestMappingInfo> currentRequestMappingInfo = new ThreadLocal<>();

    public static void setCurrentRequestMappingInfo(RequestMappingInfo requestMappingInfo) {
