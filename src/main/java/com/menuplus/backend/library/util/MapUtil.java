...
public class MapUtil {
    ...
    public static void copyCreateProperties(Object source, Object target, String... ignoreProperties) {
        BeanUtils.copyProperties(source, target, ignoreProperties);
    ...
    public static void copyResponseProperties(Object source, Object target, String... ignoreProperties) {
        BeanUtils.copyProperties(source, target, ignoreProperties);
        setResponseUser(source, target, "createdUser");
        setResponseUser(source, target, "updatedUser");
    }

    private static void setResponseUser(Object source, Object target, String fieldName) {
        try {
            Field fieldCreatedUser = source.getClass().getSuperclass().getDeclaredField(fieldName);
    ...
    private static void setDefaultValue(Object obj, String fieldName, Object fieldValue) {
        try {
            Field field;
            try {
