...
public class PageUtil {
    ...
    public static <T, C extends BaseListRequest> Order generateOrder(
        C criteriaRequest,
        CriteriaBuilder criteriaBuilder,
        Root<T> root,
        String columnSortDefault
    ) {
    ...
    public static <T, C extends BaseListRequest> Order generateOrder(
        ...
        if (StringUtils.hasText(sortBy)) {
            ...
            if (sortByArr.length > 1) {
                ...
                if (
                    directionParam.toUpperCase().equals(Constant.ASCENDING_SORT)
                ) {
    ...
    public static <C extends BaseListRequest> Order generateOrder(
        C criteriaRequest,
        CriteriaBuilder criteriaBuilder,
        Join<?, ?> join,
        String sortField
    ...
    public static <C extends BaseListRequest> Order generateSortOrder(
        C criteriaRequest,
        CriteriaBuilder criteriaBuilder,
        From join,
        String sortField
        ...
        if (
            !criteriaRequest.hasSortDirection() &&
            (sortField.equals(Constant.COLUMN_DEFAULT_SORT) ||
                sortField.equals(Constant.COLUMN_CREATED_AT) ||
                sortField.equals(Constant.COLUMN_ID))
        ) {
