...
public class RolePermissionMapper {
    ...
    public static RolePermission createEntity(
        RolePermissionCreateDto createDto
    ) {
    ...
    public static RolePermissionResponseDto createResponse(
        ...
        if (entity.getPermission() != null) {
            responseDto.setPermission(
                PermissionMapper.createResponse(entity.getPermission())
            );
        }
        return responseDto;
    }
