...
public interface RolePermissionService {
    List<RolePermissionResponseDto> createMany(List<RolePermissionCreateDto> createDtos);

    List<RolePermissionResponseDto> upsert(Long roleId, List<RolePermissionCreateDto> updateDtos);
