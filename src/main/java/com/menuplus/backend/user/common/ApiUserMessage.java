...
public class ApiUserMessage extends ApiMessageBase {
    ...
    public static ApiMessageBase
            ...
            USER_NOT_FOUND = new ApiUserMessage(3002001, "user.not_found"),
            ROLE_CREATE_SUCCESS = new ApiUserMessage(3002001, "role.create_success"),
            ROLE_UPDATE_SUCCESS = new ApiUserMessage(3002001, "role.update_success"),
            ROLE_DELETE_SUCCESS = new ApiUserMessage(3002001, "role.delete_success"),
            ROLE_EXPORT_SUCCESS = new ApiUserMessage(3002001, "role.export_success"),
