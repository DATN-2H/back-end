...
public class RoleController {
    ...
    @PostMapping(value = "")
    public Response<RoleResponseDto> create(@Valid @RequestBody RoleCreateDto createDto) {
        return Response.success(roleService.create(createDto), ApiUserMessage.ROLE_CREATE_SUCCESS);
    }
    ...
    public Response<RoleResponseDto> update(
        ...
        return Response.success(roleService.update(id, updateDto), ApiUserMessage.ROLE_UPDATE_SUCCESS);
    }
