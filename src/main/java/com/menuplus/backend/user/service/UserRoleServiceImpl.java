...
public class UserRoleServiceImpl implements UserRoleService {
    ...
    public List<UserRoleResponseDto> upsert(
        ...
        List<UserRole> existingUserRoles = userRoleRepository.findByUserId(
            userId
        );
    ...
    private List<UserRoleResponseDto> updateMany(
        ...
        Map<Long, UserRoleCreateDto> updateDtoMap = updateDtos
            .stream()
            .collect(
                Collectors.toMap(UserRoleCreateDto::getId, Function.identity())
            );
    ...
    @Override
    @Transactional
    public void setRoleForUser(Long userId, SystemRole role) {
