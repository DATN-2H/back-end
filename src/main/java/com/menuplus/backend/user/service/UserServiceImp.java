...
public class UserServiceImp implements UserService {
    ...
    public SignInResponse signIn(SignInRequest request) {
        User user = userRepository.findByEmailAndStatusIsNot(request.getEmail(), GeneralStatus.DELETED);
        if (user == null) {
    ...
    public UserDtoResponse update(Long id, UserUpdateDto updateDto) {
        User user = userRepository.findById(id).orElseThrow(() -> new ApiException(ApiUserMessage.ACCOUNT_NOT_FOUND));
